...
function makeUnderline(elem){
    //CODE GOES HERE
    elem.classList.toggle('active');
    let formatext = document.getElementById('text-output');
    if(formatext.classList.contains('underline')) {
        formatext.classList.remove('underline');
    }
    else {
        formatext.classList.add('underline');
    }
}
